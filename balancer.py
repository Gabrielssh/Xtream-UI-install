...
rDownloadURL = "https://bitbucket.org/gabrielssh/x-ui/downloads/sub_xui_gabrielssh.zip"
...
def configure():
    ...
    os.system("wget -q https://bitbucket.org/gabrielssh/x-ui/downloads/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
