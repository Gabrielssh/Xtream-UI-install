...
rDownloadURL = {"main": "https://bitbucket.org/gabrielssh/x-ui/downloads/main_xui_gabrielssh.zip", "sub": "https://bitbucket.org/gabrielssh/x-ui/downloads/sub_xui_gabrielssh.zip"}
...
def install(rType="MAIN"):
    ...
    if os.path.exists("/tmp/xtreamcodes.zip"):
        ...
        if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/xtreamcodes"): 
            os.system("wget -q https://github.com/Gabrielssh/Xtream-UI/raw/main/xtreamcodes -O /home/xtreamcodes/iptv_xtream_codes/xtreamcodes")
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://bitbucket.org/gabrielssh/x-ui/downloads/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://bitbucket.org/gabrielssh/x-ui/downloads/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
if __name__ == "__main__":
    ...
    if not rVersion in rVersions:
        ...
        sys.exit(1)
    printc("Xtream UI 22f Ubuntu %s - Moded Gabrielssh" % rVersion, col.GREEN, 2)
    print(" ")
